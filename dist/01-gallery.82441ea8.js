...
})({"laXqK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "7911853a82441ea8";
"use strict";
...
},{}],"bFsiA":[function(require,module,exports) {
...
const createMarkup = (images)=>images.map(({ preview , original , description  })=>{
        return `
      <a href="${original}">
...
;
const markup = createMarkup(_galleryItems.galleryItems);
const renderMarkup = (strings)=>{
    galleryRef.insertAdjacentHTML('beforeend', strings);
};
renderMarkup(markup);
const lightbox = new _simplelightboxDefault.default('.gallery a', {
    captionsData: 'alt',
...
const onClick = (e)=>{
    ...
    else lightbox.open(e.target);
};
galleryRef.addEventListener('click', onClick);

},{"simplelightbox":"2BNtz","simplelightbox/dist/simple-lightbox.min.css":"2D7fJ","./gallery-items":"beITQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2BNtz":[function(require,module,exports) {
...
},{}],"2D7fJ":[function() {},{}],"beITQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["laXqK","bFsiA"], "bFsiA", "parcelRequire4c75")

//# sourceMappingURL=01-gallery.82441ea8.js.map
